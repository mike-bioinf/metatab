...
from _paper.analysis.boxplot.types import simple_pair, complex_pair, simple_pairs, complex_pairs
from _paper.analysis.boxplot.pairs import yield_list_same_category_indices, select_pairs
