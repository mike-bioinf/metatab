...
def parse_args(args):
    ...
    ## TODO: list which estimators cannot be tuned in the help section
    p.add_argument("-t", "--tune", action="store_true", 
                   help="""Tune estimator hyperparameters. We use pre-defined spaces to optimize. 
                   See '--tune-space' option for more details. Note that not all estimators can be tuned.
                   Setting this parameter for untunable estimators will result in an error.""")

    ## TODO: add link or info to datasets collection
    p.add_argument("--tune-algo", choices=["random", "tpe", "meta"], default="tpe",
                   ...
                   Ignored when the '--tune' flag is down.""")
    ...
    p.add_argument("--tune-meta-surrogate-model", default=None,
                   ...
                   Ignored when the '--tune' flag is down or '--tune-algo' is not "meta".""")
