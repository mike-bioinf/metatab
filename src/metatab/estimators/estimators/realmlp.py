...
class RealMLPClassifierInterface:
    '''
    ...
    def fit(self, X: XType, y: YType, eval_set: list[tuple[XType, YType]], **kwargs) -> "RealMLPClassifierInterface":
        '''
    ...
    def set_params(self, **params) -> "RealMLPClassifierInterface":
...
class MyRealMLPClassifier(DefaultEstimatorMixin, AbstractBaseEstimator):
    ...
    Attributes:
        estimator_ (RealMLPClassifierInterface|Pipeline): Fitted classifier or pipeline object.
    '''
    ...
    def fit(self, X: XType, y: YType) -> "MyRealMLPClassifier":
        self.estimator_ = super().fit_estimator(
            X=X,
            y=y,
            classifier_cls=RealMLPClassifierInterface,
